...
/// @brief Define the default value of maximum local work that each thread executes between two consecutive of the
...
/// @brief Define the default total number of the executed operations. Notice that benchmarks for stacks and queues
...
/// @brief Define the type of the return value that most operations in the provided benchmarks return.
...
/// @brief Define the type of the argument value of atomic operations provided by the implemented concurrent objects.
