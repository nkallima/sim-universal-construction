...
/// @brief This function searches for a specifc key in the hash-table. In case that CLHHashSearch finds the key,
...
/// @brief This function searches for a specifc key in the hash-table. In case that CLHHashDelete finds the key,
